...
В стеке БЭМ-технологий есть [блок i-bem](http://ru.bem.info/technology/i-bem/2.3.0/i-bem-js/) библиотеки `bem-core`. Его JavaScript-реализация использует предметную область БЭМ
и позволяет насладиться всеми преимуществами разработки по принципам БЭМ не только программируя внешний вид компонент, но и их поведение.
...
компонентов](http://events.yandex.ru/events/yasubbotnik/msk-jul-2012/talks/302/)»,
прозвучавшего на
[Я.Субботнике](http://events.yandex.ru/events/yasubbotnik/) в июле 2012.
...
i-bem](http://ru.bem.info/technology/i-bem/2.3.0/i-bem-js/).
